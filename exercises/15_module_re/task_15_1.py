...
import argparse
import re
from task_15_1b import regex

parser = argparse.ArgumentParser(description='Output string with...')

parser.add_argument('file_in', action="store", help="filename")
parser.add_argument('regex', action="store", help="regex string")

...
device = input('Enter device name(r1, r2 or sw1): ')
keys = list(london_co[device].keys())

print('Enter parameter name', ', '.join(keys), ' : ', end = '')
param = input()
print(london_co[device].get(param.swapcase(), ''), end = '')
print(london_co[device].get(param, ''), end = '')
print()
